...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9f9f9; color: #333; padding: 40px 20px;">
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
        ...
        <table cellpadding="6" cellspacing="0" border="0" style="margin-top: 10px; width: 100%;">
            <tr><td style="width: 40%;"><strong>Nome e Cognome:</strong></td><td>{{ $booking->guest_first_name }} {{ $booking->guest_last_name }}</td></tr>
            <tr><td><strong>Email:</strong></td><td>{{ $booking->guest_email }}</td></tr>
            <tr><td><strong>Via:</strong></td><td>{{ $booking->guest_address_street }}</td></tr>
            <tr><td><strong>Città:</strong></td><td>{{ $booking->guest_address_city }}</td></tr>
            <tr><td><strong>CAP:</strong></td><td>{{ $booking->guest_address_zip }}</td></tr>
            <tr><td><strong>Paese:</strong></td><td>{{ $booking->guest_address_country }}</td></tr>
            ...
            <tr><td><strong>Numero ospiti:</strong></td><td>{{ $booking->guests }}</td></tr>
            <tr>
