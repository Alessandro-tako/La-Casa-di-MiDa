<x-layout>
    <section class="container py-5">
        ...
        {{-- Storia --}}
        <article class="mb-5" aria-labelledby="titolo-storia">
        ...
        {{-- Struttura --}}
        <article class="mb-5" aria-labelledby="titolo-struttura">
        ...
        {{-- Galleria immagini --}}
        <section class="row justify-content-center mb-5" aria-labelledby="gallery-title">
        ...
        {{-- Servizi --}}
        <article class="mb-5" aria-labelledby="servizi-title">
