<x-layout>
    {{-- Header principale --}}
    <section class="container py-5" aria-labelledby="contatti-title">
                ...
                <article itemscope itemtype="https://schema.org/LocalBusiness">
                    ...
                    <ul class="list-unstyled text-muted">
                        ...
                        <li class="mb-3">
                            ...
                            <a href="tel:+390612345678" class="text-decoration-none link-dark" itemprop="telephone">
                                +39 06 12345678
                            </a>
                        </li>
                        <li class="mb-3">
    ...
    {{-- Come raggiungerci --}}
    <section class="container py-5" aria-labelledby="come-raggiungerci">
        <header>
    ...
    {{-- Form contatti --}}
    <section class="bg-light py-5" aria-labelledby="scrivici">
        <div class="container">
